...
namespace Office_Auto_configuration
{
    ...
    internal static class Resources
    {
        ...
        internal const string TextLyncConfigurationTitle = "Настройка Skype for Business (MS Lync)";
        internal const string TextRegistryKeysConfiguration = "Конфигурация реестра";
